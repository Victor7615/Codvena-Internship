...
if model is None or latest_data is None:
    ...
    with col1:
        ...
        user_inputs["AVG_DOWNHOLE_PRESSURE"] = last_known_values['AVG_DOWNHOLE_PRESSURE']
        user_inputs["AVG_DOWNHOLE_TEMPERATURE"] = last_known_values['AVG_DOWNHOLE_TEMPERATURE']
        user_inputs["AVG_DP_TUBING"] = last_known_values['AVG_DP_TUBING']
        user_inputs["AVG_ANNULUS_PRESS"] = last_known_values['AVG_ANNULUS_PRESS']
        user_inputs["BORE_GAS_VOL"] = last_known_values['BORE_GAS_VOL']
        user_inputs["BORE_WAT_VOL"] = last_known_values['BORE_WAT_VOL']
    ...
    with col2:
        ...
        if st.button("Forecast Next Day's Production", type="primary"):
            with st.spinner("Generating features and running prediction..."):
                ...
                # Ensure feature order matches model's expectation
                # The MLflow pyfunc model handles this automatically, but it's good practice
